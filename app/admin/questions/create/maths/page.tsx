...
import { Calculator, ArrowLeft, Construction } from 'lucide-react'; // Added Construction icon

export default function AdminCreateMathsPage() {
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3 mb-2">
             ...
             <h1 className="text-3xl font-bold text-gray-900">Create Maths Question</h1>
          </div>
          <p className="text-gray-600">Define a new mathematical problem.</p>
        </div>
        ...
        <div className="bg-white rounded-xl border-2 border-gray-200 p-12 text-center shadow-sm">
            ...
            <p className="text-gray-600">
                The form for creating Maths questions (MCQ, Integer Input, etc.) is under construction.
            </p>
        </div>
